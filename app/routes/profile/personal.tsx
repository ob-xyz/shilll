  ...
  return (
    <div className="adform-container">
      ...
      <h2>Make something with <span>Shilll</span></h2>
        ...
        <br /><br /><br />
        <Link className="text" to="/profile/personal">But compensation is complex. Everyone wants wildly different things. And often it depends what your latest interest and priorities are.</Link>
        <br /><br /><br />
