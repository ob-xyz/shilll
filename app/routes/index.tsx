  ...
  return (
    <div className="container">
      ...
      <h2><span>Shilll</span> is a physical goods company</h2>
        <Link className="text" to="/subscribe">Shilll's mission is empowering individuals to make physical things. Today we're a small team of highly technical advisors helping solo entrepreneurs and small teams turn a napkin sketch into a physical product people love. If you'd like to join our mission contact <span>chris@shilll.com</span></Link>
      </div>
