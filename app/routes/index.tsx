  ...
  return (
    <div className="container">
      ...
      <h2><span>Shilll</span> is a physical goods company</h2>
        <Link className="text" to="/subscribe">Shilll's mission is empowering individuals to make physical things. Today we're a small team of highly technical advisors building emulators that enable solo entrepreneurs and small teams to turn back of the napkin sketches into a physical products people love. If you'd like to join our mission contact <span>chris@shilll.com</span></Link>
      </div>
