...
export default function Index() {
  return (
    <div className="container">
      ...
      <h2><span>Shilll</span> is the innovation company</h2>
        <Link className="text" to="/subscribe">Shilll's mission is empowering individuals to innovate.</Link>
        <br /><br /><br />
