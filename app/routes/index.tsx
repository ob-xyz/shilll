...
export default function Index() {
  ...
  return (
    <div className="container">
      ...
      <p>Shilll replaces infinite scrolling with intentional insights. Our 1-minute newsletters are meticulously designed to empower the minds of individuals wanting to live more.</p>
      </a>
      </div>
