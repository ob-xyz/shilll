...
export default function Index() {
  ...
  return (
    <div className="container">
      ...
      <h2>Elevate your life a little bit more with <span>just one newsletter</span></h2>
      <a title="subscription form" href="https://jeffamazon.com/subscribe"  rel="noopener noreferrer">
      <p>Shilll's mission is to help you scroll less and live more. Elevate your life a little more with our 1-minute newsletters, meticulously designed and highly curated to be quick, informative, and awfully fun.</p>
      </a>
      </div>
