...
export default function Index() {
  ...
  return (
    <div className="container">
      ...
      <p>Shilll's mission is to help humanity scroll less and live more. Our 1-minute newsletters are meticulously designed to give you the power to elevate your life and take back your time.</p>
      </a>
      </div>
